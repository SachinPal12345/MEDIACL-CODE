...
import computerLab from '../images/Hai.png'
import Kuch from '../../src/images/Kuch.png'
  ...
  return (
    <>
      ...
      <section id="facilities" className={`facilities ${isVisible ? 'visible' : ''}`}>
        ...
        <div className="row">
          <div className="facilities-col">
            <img style={{height:"80%"}} src={library} alt="Library" />
            <h3 style={{color:'#22577a',fontSize:'17px'}}>LIBRARY</h3>
          </div>
          <div className="facilities-col" >
            <img style={{height:"80%"}} src={computerLab} alt="Playground" />
             <h3 style={{color:'#22577a',fontSize:'17px'}}>LABORATORY</h3>
          </div>
          <div className="facilities-col">
            <img style={{height:"80%"}} src={Kuch} alt="Cafeteria" />
            <h3 style={{color:'#22577a',fontSize:'17px'}}>AUDITORIUM</h3>
          </div>
