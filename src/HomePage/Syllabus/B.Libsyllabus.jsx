    ...
    <Nav/>
      ...
      <div className="ddd" style={{ color: "black" }}>
        ...
        <h5 style={{ textAlign: "center", color: "Brown" }}>
          <b>
         <Link to = "https://www.sssutms.co.in/cms/Areas/Website/Files/Link/SYLLABUS/BLIB_MLIB%20SYL/BLISISYLL.pdf"> FIRST SEMESTER</Link>   <br /><br/>
          <Link to = "https://www.sssutms.co.in/cms/Areas/Website/Files/Link/SYLLABUS/BLIB_MLIB%20SYL/BLISIISYL.pdf"> SECOND SEMESTER</Link> 
          </b>
        </h5>
        <br />
      </div>
