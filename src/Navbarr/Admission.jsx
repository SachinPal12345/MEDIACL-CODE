...
const Admission = () => {
  ...
  const handleBranchChange = (e) => {
    ...
    setFormData({ ...formData, courseBranch: e.targe.value });
    setErrors({
      ...errors,
  ...
  const handleSubmit = async (e) => {
    ...
    if (validate()) {
      try {
        const response = await axios.post('https://sssutms.ac.in/apitest/v1/admission-enquiry', formData);
            ...
            <div className="container">
              <div className="nav-bar d-flex">
                <a href="tel:0098 765 432" className="contact-number d-flex">
                  ...
                  <span className="spann" style={{ color: 'white' }}>SRI SATYA SAI UNIVERSITY OF TECHNOLOGY & MEDICAL SCIENCES</span>
                </a>
              ...
              <div className="hero-wrapper d-flex">
                <div className="content-rgt">
                  ...
                  <div className="call-wrapper">
                    <div className="call-content">
                      <span>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="#fff" width={32} height={32} viewBox="0 0 32 32" style={{ fill: "#fff" }}>
                      ...
                      <a href="tel:7300 135 672">
                        <span className="call-title" style={{ color: 'white' }}>Call Us- 9425308462</span>
                      </a>
                    </div>
                  </div>
                </div>
                <div className="hero-form">
                  <div className="title-wrapper d-flex">
                    <h3 className="form-title" style={{ color: 'white' }}>Enquiry Now </h3>
                    ...
                    <Form onSubmit={handleSubmit}>
                      ...
                      <Form.Group className="form-item">
                        ...
                        >
                          ...
                          {courseType && courseData[courseType].courses.map(course => (
                      ...
                      <Form.Group className="form-item">
                        ...
                        >
                          ...
                          {courseName &&
                            courseData[courseType].branches[courseName].map((branch) => (
                ...
                <div className="grid">
                  <article>
                    ...
                    <div className="text">
                      ...
                      <h6> Bachelor of Animation & Design</h6>
                    </div>
                  </article>
                  ...
                  <article>
                    <div className="text">
                      ...
                      <h6> Bachelor of  Arts, Humanities & Social Sciences </h6>
                    </div>
                  </article>
