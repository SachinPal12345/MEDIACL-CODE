      ...
      <ThemeProvider theme={theme}>
        ...
        >
          <Grid container sx={{ justifyContent: "center" }}>
            ...
            <Grid
              container
              style={{ marginTop: "40px", marginLeft: "20px", width: "600px" }}
              rowSpacing={1}
                      ...
                      <div class="card-body pt-0">
                        ...
                        >
                          ...
                          <tr>
                            ...
                            <td width="2%">:</td>
                            <td>
                              {studentData.professional.ScholarshipRequired}Not
                              Eligible{" "}
                            </td>
                          </tr>
                    ...
                    <div class="card-body pt-0">
                      ...
                      >
                        <tr>
                          ...
                          <td>
                            {studentData &&
                              studentData.Documents?.aadharCard && (
                                <Link
                                  to={studentData.Documents.aadharCard}
                                  // target="_blank"
                          ...
                          <td>
                            {studentData &&
                              studentData.Documents?.applicantSignature && (
                                <Link
                                  to={studentData.Documents.applicantSignature}
                                  target="_blank"
                                  rel="noopener noreferrer"
                                >
                                  View Signature
                          ...
                          <td>
                            {studentData &&
                              studentData.Documents?.domicileCertificate && (
                                <Link
                                  to={studentData.Documents.domicileCertificate}
                                  target="_blank"
                                  rel="noopener noreferrer"
                                >
                                  View Ceretificate
                          ...
                          <td>
                            {studentData &&
                              studentData.Documents?.incomeCertificate && (
                                <Link
                                  to={studentData.Documents.incomeCertificate}
                                  target="_blank"
                                  rel="noopener noreferrer"
                                >
                                  View Certificate
                        ...
                        <tr>
                          ...
                          <td>
                            {studentData &&
                              studentData.Documents?.marksheet10th && (
                                <Link
                                  to={studentData.Documents.marksheet10th}
                                  target="_blank"
                                  rel="noopener noreferrer"
                                >
                                  View Marksheet
                        ...
                        <tr>
                          ...
                          <td>
                            {studentData &&
                              studentData.Documents?.marksheet12th && (
                                <Link
                                  to={studentData.Documents.marksheet12th}
                                  target="_blank"
                                  rel="noopener noreferrer"
                                >
                                  View Marksheet
                          ...
                          <td>
                            {studentData &&
                              studentData.Documents?.transferCertificate && (
                                <Link
                                  to={studentData.Documents.transferCertificate}
                                  target="_blank"
                                  rel="noopener noreferrer"
                                >
                                  View Certificate
                        ...
                        {studentData.academicDetails && (
                          <>
                            ...
                            <tr>
                              ...
                              <td width="2%">:</td>
                              <td>
                                {studentData.academicDetails.tenthPassingYear}
                              </td>
                            </tr>
                            ...
                            <tr>
                              ...
                              <td width="2%">:</td>
                              <td>
                                {studentData.academicDetails.tenthMaxMarks}
                              </td>
                            </tr>
                            ...
                            <tr>
                              ...
                              <td width="2%">:</td>
                              <td>
                                {studentData.academicDetails.tenthMarksObtain}
                              </td>
                            </tr>
                            ...
                            <tr>
                              ...
                              <td width="2%">:</td>
                              <td>
                                {studentData.academicDetails.tenthPercentage}
                              </td>
                            </tr>
                            <tr>
                              <th
                            ...
                            <tr>
                              ...
                              <td width="2%">:</td>
                              <td>
                                {studentData.academicDetails.twelfthPassingYear}
                              </td>
                            </tr>
                            <tr>
                              <th
                              ...
                              <td width="2%">:</td>
                              <td>
                                {studentData.academicDetails.twelfthMaxMarks}
                              </td>
                            </tr>
                            <tr>
                              <th
                              ...
                              <td width="2%">:</td>
                              <td>
                                {studentData.academicDetails.twelfthMarksObtain}
                              </td>
                            </tr>
                            ...
                            <tr>
                              ...
                              <td width="2%">:</td>
                              <td>
                                {studentData.academicDetails.twelfthPercentage}
                              </td>
                            </tr>
                            <tr>
                              <th
                              ...
                              <td width="2%">:</td>
                              <td>
                                {studentData.academicDetails.twelfthRollNo}
                              </td>
                            </tr>
                          </>
                        )}
