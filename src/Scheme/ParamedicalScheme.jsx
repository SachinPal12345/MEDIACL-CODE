    ...
    <Nav />
      ...
      <div className="ddd" style={{ color: "black" }}>
        ...
        <h4 style={{ textAlign: "center", color: "Brown" }}>
          <b>
          <h4><span><Link to = "">New Scheme (With effect from 2016-17)</Link></span>
         <br/> <br/>
         New Scheme (With effect from 2017-18)</h4>
          </b>
        </h4>
        <br />
        <br/>
...
export default ParamedicalScheme;
